with open("C:/Python_Workspace/Jump_to_Python\chap04/20180509(수)/방명록.txt", 'r', encoding='utf-8') as f:
    visitors_list = []
...
if not check_flag:
    with open("C:/Python_Workspace/Jump_to_Python\chap04/20180509(수)/방명록.txt", 'a', encoding='utf-8') as f:
